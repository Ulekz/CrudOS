...
urlpatterns = [
    ...
    path('reporte/historico_apuestas/', views.generar_reporte_historico_apuestas, name='generar_reporte_historico_apuestas'),
    path('reporte/historico_apuestas_excel/', views.generar_reporte_historico_apuestas_excel, name='generar_reporte_historico_apuestas_excel'),
