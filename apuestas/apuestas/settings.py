...
SECRET_KEY = 'django-insecure-sfc-hf$v^y((@yaigjtnv2hth_s$c5gv28wgs%l*41km7sr(g!'
...
# Directorio donde Django reunirá todos los archivos estáticos durante la fase de recolección
...
EMAIL_HOST = 'smtp.example.com'# servidor de correos real 
EMAIL_PORT = 587
EMAIL_USE_TLS = True
